...
Src/%.o Src/%.su Src/%.cyclo: ../Src/%.c Src/subdir.mk
	arm-none-eabi-gcc "$<" -mcpu=cortex-m4 -std=gnu11 -g3 -DUSE_HAL_DRIVER -DSTM32F407xx -c -I../Inc -I"D:/Embedded-C/My_Workspace/hal/005_Interrupt_UART/Drivers/CMSIS/Include" -I"D:/Embedded-C/My_Workspace/hal/005_Interrupt_UART/Drivers/CMSIS/Device/ST/STM32F4xx/Include" -I"D:/Embedded-C/My_Workspace/hal/005_Interrupt_UART/Drivers/STM32F4xx_HAL_Driver/Inc" -O0 -ffunction-sections -fdata-sections -Wall -fstack-usage -fcyclomatic-complexity -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" --specs=nano.specs -mfloat-abi=soft -mthumb -o "$@"
